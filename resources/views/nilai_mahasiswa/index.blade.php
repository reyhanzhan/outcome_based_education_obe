            ...
            <div class="card-body">
                ...
                <form action="{{ route('nilai.mahasiswa.store') }}" method="POST" id="nilaiForm">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <small class="form-text text-muted">Pilih standar minimum untuk semua CPMK di MK ini. Klik kode CPMK untuk melihat deskripsi dan teknik penilaian.</small>
                    </div>
                                    ...
                                    @foreach ($cpmks as $cpmk)
                                        <th class="bobot-highlight">
                                            <span class="cpmk-code"
                                                  ...
                                                  data-teknik="{{ json_encode($cpmk->teknikPenilaian->map(function($teknik) {
                                                      return ['teknik' => $teknik->teknik, 'bobot' => $teknik->bobot];
                                                  })->toArray()) }}"
                                                  style="cursor: pointer;">
                                                {{ $cpmk->kode_cpmk }} ({{ $cpmk->mks->where('id', $mk->id)->first()->pivot->bobot ?? 0 }}%)
                                            </span>
                                        </th>
                                    @endforeach
                                </tr>
