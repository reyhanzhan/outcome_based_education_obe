...
@section('content')
    <div class="d-flex justify-content-center align-items-center min-vh-100">
        <div class="form-card shadow-lg p-4 rounded-4 bg-white">
            <h2 class="text-center mb-3 text-dark font-weight-bold">Tambah Data Bahan Kajian</h2>
            ...
            <form action="{{ route('bk.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-4 position-relative">
                    ...
                    <label for="kode_bk" class="form-label" style="color: #8293e4; font-weight: bold;">
                        Kode BK<span class="text-danger">*</span>
                    </label>
                    <input type="text" name="kode_bk" class="form-control" id="kode_bk"
                ...
                <div class="d-flex gap-3 mt-4">
                    ...
                    <a href="{{ url('BK/index') }}" type="button" class="btn btn-primary btn-block custom-btn-blue">
