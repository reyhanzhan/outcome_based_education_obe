...
<div class="container py-4">
    ...
    <div class="card p-4 shadow-lg border-0 mb-5"
        ...
        <div class="d-flex justify-content-between mb-3">
            <a href="{{ url('/MK/create') }}" class="btn btn-success btn-custom">
            ...
            <table class="table table-bordered table-hover table-striped custom-table">
                <thead>
                    <tr>
                        ...
                        <th style="color: #ffffff !important; background-color: #0052A2 !important;">MK</th>
                        <th style="color: #ffffff !important; background-color: #0052A2 !important;">SINGKATAN MK</th>
                        <th style="color: #ffffff !important; background-color: #0052A2 !important;">AKSI</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($mk as $index => $mkes)
                        <tr>
                            <td>{{ $index + 1 }}</td>
                            <!-- Kondisi untuk Mobile dan Desktop -->
                            <td>
                                <span class="d-none d-md-block">{{ $mkes->deskripsi }}</span>
                            ...
                            <td>
                                ...
                                <div class="action-buttons">
                                    <a href="{{ route('mk.edit', $mkes->id) }}" class="btn btn-warning btn-action btn-edit btn-sm">
                                        <i class="bi bi-pencil me-1"></i> Ubah
                                    </a>
                                    <form action="{{ route('mk.destroy', $mkes->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                                        @csrf
                                        @method('DELETE')
