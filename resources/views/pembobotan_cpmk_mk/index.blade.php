...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            // Inisialisasi Select2 untuk mata kuliah dengan AJAX
            $('#mkSelect').select2({
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <table class="table table-bordered teknik-penilaian-table" data-cpmk="${cpmk.id}">
                                                    ...
                                                    <tbody>
                                                        <tr><td>Partisipasi(Kuis)</td><td><input type="number" class="teknik-bobot-input form-control" data-cpmk="${cpmk.id}" data-teknik="Kuis" value="${cpmk.teknik_penilaian?.Kuis || 0}" min="0" max="100" step="1"></td></tr>
                                                        <tr><td>Observasi(Praktik/Tugas)</td><td><input type="number" class="teknik-bobot-input form-control" data-cpmk="${cpmk.id}" data-teknik="Tugas" value="${cpmk.teknik_penilaian?.Tugas || 0}" min="0" max="100" step="1"></td></tr>
                                                        <tr><td>Unjuk Kerja(Presentasi)</td><td><input type="number" class="teknik-bobot-input form-control" data-cpmk="${cpmk.id}" data-teknik="Presentasi" value="${cpmk.teknik_penilaian?.Presentasi || 0}" min="0" max="100" step="1"></td></tr>
                                                        <tr><td>Tes Tulis(UTS)</td><td><input type="number" class="teknik-bobot-input form-control" data-cpmk="${cpmk.id}" data-teknik="UTS" value="${cpmk.teknik_penilaian?.UTS || 0}" min="0" max="100" step="1"></td></tr>
                                                        <tr><td>Tes Tulis(UAS)</td><td><input type="number" class="teknik-bobot-input form-control" data-cpmk="${cpmk.id}" data-teknik="UAS" value="${cpmk.teknik_penilaian?.UAS || 0}" min="0" max="100" step="1"></td></tr>
                                                        <tr><td>Tes Lisan(Tugas Kelompok)</td><td><input type="number" class="teknik-bobot-input form-control" data-cpmk="${cpmk.id}" data-teknik="Tugas Kelompok" value="${cpmk.teknik_penilaian?.['Tugas Kelompok'] || 0}" min="0" max="100" step="1"></td></tr>
                                                    </tbody>
                                                </table>
                                                <p class="total-bobot-teknik-p"><strong>Total Bobot Teknik (${cpmk.kode_cpmk}): <span class="total-bobot-teknik" data-cpmk="${cpmk.id}">0</span>%</strong></p>
                                            </td>
    ...
    <style>
        .teknik-bobot-input[type="number"] { -moz-appearance: textfield; }
        .teknik-bobot-input[type="number"]::-webkit-inner-spin-button,
        .teknik-bobot-input[type="number"]::-webkit-outer-spin-button { -webkit-appearance: none; margin: 0; }
        .form-group .select2-container { width: 100% !important; }
        .select2-container--default .select2-selection--single { height: 38px !important; border: 1px solid #d2d6de; display: flex !important; align-items: center !important; }
        .select2-container--default .select2-selection--single .select2-selection__arrow { height: 38px !important; top: 0 !important; right: 10px !important; display: flex !important; align-items: center !important; }
        .total-bobot-teknik-p { margin-bottom: 20px !important; }
        .cpmk-label { font-weight: 700; font-size: 1rem; color: #212529; background-color: #f8f9fa; padding: 0.5rem; border-bottom: 2px solid #dee2e6; margin-bottom: 0.5rem; }
